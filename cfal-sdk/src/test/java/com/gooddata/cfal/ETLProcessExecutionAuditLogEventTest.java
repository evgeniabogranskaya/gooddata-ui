...
public class ETLProcessExecutionAuditLogEventTest extends AbstractProjectAuditLogEventTest {
    ...
    public void shouldSetValuesFromGdcCallContext() {
        final ETLProcessExecutionAuditLogEvent event = new ETLProcessExecutionAuditLogEvent(ETL_SCHEDULE_CHANGE, true, PROCESS, EXECUTION);
